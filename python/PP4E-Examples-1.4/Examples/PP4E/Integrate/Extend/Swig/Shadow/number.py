...
class Number(_object):
    ...
    def __init__(self, *args): 
        this = _number.new_Number(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _number.delete_Number
    __del__ = lambda self : None;
    def add(self, *args): return _number.Number_add(self, *args)
    def sub(self, *args): return _number.Number_sub(self, *args)
    def square(self): return _number.Number_square(self)
    def display(self): return _number.Number_display(self)
    __swig_setmethods__["data"] = _number.Number_data_set
    __swig_getmethods__["data"] = _number.Number_data_get
    if _newclass:data = _swig_property(_number.Number_data_get, _number.Number_data_set)
